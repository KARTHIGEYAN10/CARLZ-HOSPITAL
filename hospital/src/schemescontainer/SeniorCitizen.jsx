...
import old1 from "../assets/old1.jpeg"
const SeniorCitizen = () => {
    const datalist = [
            { plantitle: "Child Wellness plan", img: old1, agegroup:"0-10", gender:[0,1], plan_validity:"6 months", plan_expire:"01/10/25" },
            { plantitle: "Newborn Care Package", img: old1, agegroup:"0-1", gender:[0,1], plan_validity:"1 yr", plan_expire:"04/10/25" },
