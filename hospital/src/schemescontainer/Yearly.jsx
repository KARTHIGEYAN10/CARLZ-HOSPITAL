...
import quaterly from "../assets/quartely.jpeg";
import halfyearly from "../assets/halfearly.jpeg";
import annual from "../assets/annual.jpeg"
const Yearly = () => {
    const datalist = [
            { plantitle: "Child Wellness plan", img: quaterly, agegroup:"0-10", gender:[0,1], plan_validity:"6 months", plan_expire:"01/10/25" },
            { plantitle: "Newborn Care Package", img: halfyearly, agegroup:"0-1", gender:[0,1], plan_validity:"1 yr", plan_expire:"04/10/25" },
            { plantitle: "Child Wellness plan", img: annual, agegroup:"0-10", gender:[0,1], plan_validity:"6 months", plan_expire:"01/10/25" },
            { plantitle: "Newborn Care Package", img: annual, agegroup:"0-1", gender:[0,1], plan_validity:"1 yr", plan_expire:"04/10/25" },
            { plantitle: "Child Wellness plan", img: quaterly, agegroup:"0-10", gender:[0,1], plan_validity:"6 months", plan_expire:"01/10/25" },
            { plantitle: "Newborn Care Package", img: halfyearly, agegroup:"0-1", gender:[0,1], plan_validity:"1 yr", plan_expire:"04/10/25" }
          ];
