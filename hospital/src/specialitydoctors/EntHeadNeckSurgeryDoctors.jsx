...
const EntHeadNeckSurgeryDoctors = () => {
    ...
    const Entheadneckcdoctor=d["ENT, Head & Neck Surgery"]
  return (
    <div className='flex md:justify-start gap-4 items-center flex-wrap justify-center'>
                {Entheadneckcdoctor.map((item,index)=>(
...
export default EntHeadNeckSurgeryDoctors