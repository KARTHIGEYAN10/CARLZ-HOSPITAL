...
const RehabillitationMedicineDoctors = () => {
    ...
    const Rehabillitationdoctor=d["Rehabilitation Medicine"]
  return (
    <div className='flex md:justify-start gap-4 items-center flex-wrap justify-center'>
                                                        {Rehabillitationdoctor.map((item,index)=>(
...
export default RehabillitationMedicineDoctors