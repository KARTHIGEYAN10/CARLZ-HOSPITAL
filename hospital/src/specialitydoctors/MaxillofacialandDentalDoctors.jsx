...
const MaxillofacialandDentalDoctors = ({selectedDoctor,setSelectedDoctor}) => {
    ...
    const MaxillofacialDentaldoctor=d["Maxillofacial & Dental Surgery"]
  return (
    <div className='flex md:justify-start gap-4 items-center flex-wrap justify-center'>
                                    {MaxillofacialDentaldoctor.map((item,index)=>(
...
export default MaxillofacialandDentalDoctors