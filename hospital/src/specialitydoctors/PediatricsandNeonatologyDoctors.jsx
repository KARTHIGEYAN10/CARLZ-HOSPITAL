...
const PediatricsandNeonatologyDoctors = () => {
    ...
    const Pediatricdoctor=d["Pediatrics and Neonatology"]
  return (
    <div className='flex md:justify-start gap-4 items-center flex-wrap justify-center'>
                                            {Pediatricdoctor.map((item,index)=>(
...
export default PediatricsandNeonatologyDoctors