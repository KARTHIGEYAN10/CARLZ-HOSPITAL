...
const HeartLungTransplantDoctors = () => {
    ...
    const Heartlungcdoctor=d["Heart & Lung Transplant and Mechanical Circulatory Support"]
  return (
    <div className='relative'>
    <div className='flex md:justify-start gap-4 items-center flex-wrap justify-center relative'>
                    {Heartlungcdoctor.map((item,index)=>(
                        ...
                        flex items-center justify-between gap-4 hover:shadow-2xl'>
                            ...
                            <button className='bg-green-600 text-white p-3 rounded-lg mt-2 hover:bg-green-900 cursor-pointer'
                            onClick={()=>handleselected(item)}>Book an appoinment</button>
                            </div>
                        </div>
                    ))
                    }
...
export default HeartLungTransplantDoctors