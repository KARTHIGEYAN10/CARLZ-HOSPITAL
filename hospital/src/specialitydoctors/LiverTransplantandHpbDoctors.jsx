...
const LiverTransplantandHpbDoctors = ({selectedDoctor,setSelectedDoctor}) => {
    ...
    const Livertransplantdoctor=d["Liver Diseases, Transplant & HPB Surgery"]
  return (
        <div className='flex md:justify-start gap-4 items-center flex-wrap justify-center'>
                                {Livertransplantdoctor.map((item,index)=>(
...
export default LiverTransplantandHpbDoctors