...
const InfectiousDiseaseandcontrolDoctors = ({selectedDoctor,setSelectedDoctor}) => {
    ...
    const InfectiousDiseaseControltdoctor=d["Infectious Disease and Infection Control"]
  return (
    <div className='flex md:justify-start gap-4 items-center flex-wrap justify-center'>
                        {InfectiousDiseaseControltdoctor.map((item,index)=>(
...
export default InfectiousDiseaseandcontrolDoctors