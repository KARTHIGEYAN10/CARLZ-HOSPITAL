...
const CardiacAnaesthesiaandCTICUDoctors = () => {
    ...
    const Cardiacanaesthesiadoctor=d["Cardiac Anaesthesia & CT ICU"]
    console.log(d)
  return (
    <div className='flex md:justify-start gap-4 items-center flex-wrap justify-center'>
                {Cardiacanaesthesiadoctor.map((item,index)=>(
...
export default CardiacAnaesthesiaandCTICUDoctors