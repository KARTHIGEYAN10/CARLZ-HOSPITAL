...
const InternalMedicineDoctors = ({selectedDoctor,setSelectedDoctor}) => {
    ...
    const InternalMedicinedoctor=d["Internal Medicine and Allied Science"]
  return (
    <div className='flex md:justify-start gap-4 items-center flex-wrap justify-center'>
                            {InternalMedicinedoctor.map((item,index)=>(
