...
const ShoulderElbowInjuriesDoctors = () => {
    ...
    const ShowlderElbowdoctor=d["Shoulder, Elbow, Hand & Sports Injuries"]
  return (
    <div className='flex md:justify-start gap-4 items-center flex-wrap justify-center'>
                                                            {ShowlderElbowdoctor.map((item,index)=>(
...
export default ShoulderElbowInjuriesDoctors